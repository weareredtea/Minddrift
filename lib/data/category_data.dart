...
const List<CategoryItem> allCategories = [
  ...
  CategoryItem(
    id: 'fear_courage',
    left: {'en': 'FEAR', 'ar': 'خوف'},
    right: {'en': 'COURAGE', 'ar': 'شجاعة'},
    bundleId: 'bundle.horror',
  ),
  CategoryItem(
    id: 'despair_hope',
    left: {'en': 'DESPAIR', 'ar': 'يأس'},
    right: {'en': 'HOPE', 'ar': 'أمل'},
    bundleId: 'bundle.horror',
  ),
  CategoryItem(
    id: 'darkness_light',
  ...
  CategoryItem(
    id: 'madness_sanity',
    left: {'en': 'MADNESS', 'ar': 'جنون'},
    right: {'en': 'SANITY', 'ar': 'عقل'},
    bundleId: 'bundle.horror',
  ),
  CategoryItem(
    id: 'dread_eagerness',
    left: {'en': 'DREAD', 'ar': 'رهبة'},
    right: {'en': 'EAGERNESS', 'ar': 'حماس'},
    bundleId: 'bundle.horror',
  ),
  CategoryItem(
    id: 'terror_peace',
    left: {'en': 'TERROR', 'ar': 'رعب'},
    right: {'en': 'PEACE', 'ar': 'سلام'},
    bundleId: 'bundle.horror',
  ),
  CategoryItem(
    id: 'doom_salvation',
    left: {'en': 'DOOM', 'ar': 'هلاك'},
    right: {'en': 'SALVATION', 'ar': 'خلاص'},
    bundleId: 'bundle.horror',
  ),
  CategoryItem(
    id: 'curse_blessing',
  ...
  CategoryItem(
    id: 'sorrow_joy',
    left: {'en': 'SORROW', 'ar': 'حزن'},
    right: {'en': 'JOY', 'ar': 'فرح'},
    bundleId: 'bundle.horror',
  ),
  CategoryItem(
    id: 'anguish_relief',
    left: {'en': 'ANGUISH', 'ar': 'كرب'},
    right: {'en': 'RELIEF', 'ar': 'راحة'},
    bundleId: 'bundle.horror',
  ),
  CategoryItem(
    id: 'grief_comfort',
    left: {'en': 'GRIEF', 'ar': 'أسى'},
    right: {'en': 'COMFORT', 'ar': 'راحة'},
    bundleId: 'bundle.horror',
  ),
  CategoryItem(
    id: 'loneliness_companionship',
    left: {'en': 'LONELINESS', 'ar': 'وحدة'},
    right: {'en': 'COMPANIONSHIP', 'ar': 'صحبة'},
    bundleId: 'bundle.horror',
  ),
  CategoryItem(
    id: 'danger_safety',
  ...
  CategoryItem(
    id: 'panic_calm',
    left: {'en': 'PANIC', 'ar': 'ذعر'},
    right: {'en': 'CALM', 'ar': 'هدوء'},
    bundleId: 'bundle.horror',
  ),
  CategoryItem(
    id: 'horror_serenity',
    left: {'en': 'HORROR', 'ar': 'رعب'},
    right: {'en': 'SERENITY', 'ar': 'طمأنينة'},
    bundleId: 'bundle.horror',
  ),
  CategoryItem(
    id: 'guilt_innocence',
  ...
  CategoryItem(
    id: 'violence_nonviolence',
    left: {'en': 'VIOLENCE', 'ar': 'عنف'},
    right: {'en': 'NONVIOLENCE', 'ar': 'لاعنف'},
    bundleId: 'bundle.horror',
  ),
  CategoryItem(
    id: 'pain_pleasure',
  ...
  CategoryItem(
    id: 'stable_unstable',
    left: {'en': 'STABLE', 'ar': 'مستقر'},
    right: {'en': 'UNSTABLE', 'ar': 'غير مستقر'},
    bundleId: 'bundle.nature',
  ),
  CategoryItem(
    id: 'sustainable_unsustainable',
    left: {'en': 'SUSTAINABLE', 'ar': 'مستدام'},
    right: {'en': 'UNSUSTAINABLE', 'ar': 'غير مستدام'},
    bundleId: 'bundle.nature',
  ),
  CategoryItem(
    id: 'steady_erratic',
    left: {'en': 'STEADY', 'ar': 'ثابت'},
    right: {'en': 'ERRATIC', 'ar': 'متقلب'},
    bundleId: 'bundle.nature',
  ),
  CategoryItem(
    id: 'renewal_erosion',
    left: {'en': 'RENEWAL', 'ar': 'تجديد'},
    right: {'en': 'EROSION', 'ar': 'تآكل'},
    bundleId: 'bundle.nature',
  ),
  CategoryItem(
    id: 'harmony_discord',
    left: {'en': 'HARMONY', 'ar': 'تناغم'},
    right: {'en': 'DISCORD', 'ar': 'تنافر'},
    bundleId: 'bundle.nature',
  ),
  CategoryItem(
    id: 'cyclical_linear',
    left: {'en': 'CYCLICAL', 'ar': 'دوري'},
    right: {'en': 'LINEAR', 'ar': 'خطي'},
    bundleId: 'bundle.nature',
  ),
  CategoryItem(
    id: 'dynamic_static',
    left: {'en': 'DYNAMIC', 'ar': 'ديناميكي'},
    right: {'en': 'STATIC', 'ar': 'ثابت'},
    bundleId: 'bundle.nature',
  ),
  CategoryItem(
    id: 'radiant_dim',
  ...
  CategoryItem(
    id: 'symmetrical_asymmetrical',
    left: {'en': 'SYMMETRICAL', 'ar': 'متناظر'},
    right: {'en': 'ASYMMETRICAL', 'ar': 'غير متناظر'},
    bundleId: 'bundle.nature',
  ),
  CategoryItem(
  ...
  CategoryItem(
    id: 'layered_flat',
    left: {'en': 'LAYERED', 'ar': 'طبقي'},
    right: {'en': 'FLAT', 'ar': 'مسطح'},
    bundleId: 'bundle.nature',
  ),
  CategoryItem(
    id: 'concentrated_diffuse',
    left: {'en': 'CONCENTRATED', 'ar': 'مركز'},
    right: {'en': 'DIFFUSE', 'ar': 'منتشر'},
    bundleId: 'bundle.nature',
  ),
  CategoryItem(
  ...
  CategoryItem(
    id: 'fate_free_will',
    left: {'en': 'FATE', 'ar': 'قدر'},
    right: {'en': 'FREE WILL', 'ar': 'إرادة حرة'},
    bundleId: 'bundle.fantasy',
  ),
  CategoryItem(
    id: 'magic_science',
  ...
  CategoryItem(
    id: 'destiny_choice',
    left: {'en': 'DESTINY', 'ar': 'مصير'},
    right: {'en': 'CHOICE', 'ar': 'اختيار'},
    bundleId: 'bundle.fantasy',
  ),
  CategoryItem(
    id: 'hope_despair',
    left: {'en': 'HOPE', 'ar': 'أمل'},
    right: {'en': 'DESPAIR', 'ar': 'يأس'},
    bundleId: 'bundle.fantasy',
  ),
  CategoryItem(
  ...
  CategoryItem(
    id: 'ephemeral_permanent',
    left: {'en': 'EPHEMERAL', 'ar': 'عابر'},
    right: {'en': 'PERMANENT', 'ar': 'دائم'},
    bundleId: 'bundle.fantasy',
  ),
  CategoryItem(
  ...
  CategoryItem(
    id: 'eternal_temporary',
    left: {'en': 'ETERNAL', 'ar': 'أبدي'},
    right: {'en': 'TEMPORARY', 'ar': 'مؤقت'},
    bundleId: 'bundle.fantasy',
  ),
  CategoryItem(
    id: 'vision_oblivion',
    left: {'en': 'VISION', 'ar': 'رؤية'},
    right: {'en': 'OBLIVION', 'ar': 'نسيان'},
    bundleId: 'bundle.fantasy',
  ),
  CategoryItem(
  ...
  CategoryItem(
    id: 'truth_mystery',
    left: {'en': 'TRUTH', 'ar': 'حقيقة'},
    right: {'en': 'MYSTERY', 'ar': 'غموض'},
    bundleId: 'bundle.fantasy',
  ),
  CategoryItem(
  ...
  CategoryItem(
    id: 'existence_nonexistence',
    left: {'en': 'EXISTENCE', 'ar': 'وجود'},
    right: {'en': 'NONEXISTENCE', 'ar': 'عدم وجود'},
    bundleId: 'bundle.fantasy',
  ),
];
