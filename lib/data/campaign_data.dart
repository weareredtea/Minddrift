...
class CampaignDatabase {
  static const List<CampaignLevel> allLevels = [
    ...
    CampaignLevel(
      ...
      categoryId: 'hungry_satiated',
      range: 5,
      specificClue: 'Completely stuffed',
      secretPosition: 85,
      difficulty: 'easy',
      maxScore: 25,
    ),
    ...
    CampaignLevel(
      ...
      range: 1,
      specificClue: 'Dragon breath spell',
      secretPosition: 20,
      difficulty: 'easy',
      maxScore: 25,
    ),
