...
class CampaignDatabase {
  static const List<CampaignLevel> allLevels = [
    ...
    CampaignLevel(
      ...
      categoryId: 'hungry_satiated',
      range: 2,
      specificClue: 'Reading a recipe',
      localizedClue: LocalizedClue(
        english: 'Reading a recipe',
        arabic: 'قراءة وصفة طعام',
      ),
      secretPosition: 30,
      difficulty: 'medium',
      maxScore: 30,
    ...
    CampaignLevel(
      ...
      categoryId: 'hungry_satiated',
      range: 3,
      specificClue: 'Just finished a salad',
      localizedClue: LocalizedClue(
        english: 'Just finished a salad',
        arabic: 'انتهيت للتو من تناول سلطة',
      ),
      secretPosition: 65,
      difficulty: 'expert',
      maxScore: 40,
    ...
    CampaignLevel(
      ...
      categoryId: 'myth_history',
      range: 3,
      specificClue: 'A Conspiracy Theory',
      localizedClue: LocalizedClue(
        english: 'A Conspiracy Theory',
        arabic: 'نظرية مؤامرة',
      ),
      secretPosition: 50,
      difficulty: 'expert',
